...
from api_functions.gemini_call import gemini_api_call, itter_gemini_call
...
def main():
    ...
    temp_text, is_match = compare_acl(acl_file, "llm-research/llm-generated-data/gemini/gemini-healthcare/gemini-ACL.txt")
    write_to_file("llm-research/llm-generated-data/gemini/gemini-healthcare/gemini.log", temp_text)
    # ttl= 10
    # complete_request_file = "llm-research/itter-complete-response.txt"
    # itter_gemini_call(is_match, ttl,abac_rules_generated, acl_file, complete_request_file )
